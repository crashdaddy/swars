...
class Vehicle extends Component {
    ...
    getData = () => {
        let starshipURL = "https://swapi.dev/api/vehicles/"+this.props.match.params.id;
    ...
    render() {
        ...
        return (
            <div style={{marginTop:'60px'}}>
               ...
               <div style={{width:'40%'}}><VehicleDetails ship={starship} /></div>
               <div style={{width:'40%',height:'400px'}}><VehicleImage ship={starship}/></div>
               </div>
               :
               ''
                }
